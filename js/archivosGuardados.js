...
baseDatos
  ...
  .then((querySnapshot) => {
    querySnapshot.forEach((doc) => {
      ...
      // impresionFormularioAts.ciudadTrabajoAltura =
      //   document.getElementById("nombrePrueba").value;
      console.log(
        doc.data().impresionFormularioTrabajoAltura.ciudadTrabajoAltura
      );
      doc.data().impresionFormularioTrabajoAltura.ciudadTrabajoAltura =
        document.getElementById("nombrePrueba");
      contenedor.innerHTML = `
            <div class="col">
              <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-title" id="nombrePrueba">Nombre obra Prueba</h5>
...
// Codigo de chat gpt card de html a java script
...
// fin de codigo de html chat gpt
