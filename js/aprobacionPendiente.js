              ...
              <div class="col">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <div class="card-body">
                      <a href="../html/visualizacionFormularioATS.html" class="card-link" id="" >Aprobacion</a>
                      <a href="../html/visualizacionFormularioAlturas.html" class="card-link" id="" >Pendiente</a>
                    </div>
                </div>
              </div>
            `;
